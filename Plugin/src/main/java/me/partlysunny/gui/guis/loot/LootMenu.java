...
public class LootMenu implements GuiInstance {
    @Override
    public Gui getGui(HumanEntity p) {
        if (!(p instanceof Player player)) return new ChestGui(3, "");
        ChestGui generalSelectionMenu = Util.getGeneralSelectionMenu(ChatColor.GOLD + "Loot", player,
                new Pair<>("lootEntriesPage", ItemBuilder.builder(Material.BOOK).setName(net.md_5.bungee.api.ChatColor.GOLD + "Loot Entries").setLore(net.md_5.bungee.api.ChatColor.GRAY + "Manage your loot entries!").build()),
